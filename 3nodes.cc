                 ...
                 const WifiMacHelper &wifiMac, const YansWifiChannelHelper &wifiChannel)
{
  ...
  NodeContainer c;
  c.Create (3); // Create 3 nodes instead of 5
...
int main (int argc, char *argv[])
{
  ...
  for (uint32_t i = 0; i < 5; ++i) { // Change to iterate 5 times for different data rates
    std::string dataMode;
    switch (i) {
  ...
  for (uint32_t i = 0; i < 5; ++i) { // Change to iterate 5 times for different rate control algorithms
